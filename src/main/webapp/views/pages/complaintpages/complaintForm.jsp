...
<html lang="en">
    ...
    <body>
        ...
        <div class="ex">
        <form name="problemForm" action="${pageContext.request.contextPath}/complaint/insert" method="post">

            <table style="with: 50%">
                <tr>
                    <td>What is a type of your health problem?</td>
                    <td>
                        <select class="form-control" id="problemType" name="complaintTypeShortName" onchange="return setValue();">
                ...
                <tr>
                    <td>Description</td>
                    <td><textarea class="form-control" type="text" name="complaintPartDescription" cols="60" rows="6"/></textarea>
                    </td>
                </tr>
            </table>
